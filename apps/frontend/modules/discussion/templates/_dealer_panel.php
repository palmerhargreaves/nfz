    ...
    <fieldset class="mod-popup-r">
        <div class="mod-popup-comment">
            ...
            <form action="<?php echo url_for('@discussion_post') ?>" method="post" class="post"
                  ...
                  id="<?php echo !empty($form_id) ? $form_id : 'discussion_upload_form'; ?>"
                  name="<?php echo !empty($form_id) ? $form_id : 'discussion_upload_form'; ?>">
                ...
                <div class="message-send-buttons">
                    ...
                    <div class="message-button-wrapper btn-add-file" id="btn-add-discussion-dealer-files">
