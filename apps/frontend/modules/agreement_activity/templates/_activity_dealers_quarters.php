...
if (!in_array($current_q, $qa_list)) {
    $current_q = $qa_list[count($qa_list) - 1];
}
?>

<div class="nav-inner inline">
    <div class="nav-inner-i">
        <ul>
            ...
            foreach ($extendedStats as $q => $data):
                ...
                <li ><a
                        href="javascript:;"
                        name="<?php echo 'activities-q-' . $q; ?>"
                        class="<?php echo $q == $current_q ? "active" : ""; ?> tabHeader"
                        data-q-idx="<?php echo $q; ?>"><?php echo $roman[$q]; ?> квартал</a>
                </li>
            <?php endforeach; ?>
        </ul>
    </div>
...
foreach ($extendedStats as $q => $data):
    ?>
    <div class="tab-pane <?php echo $q == $current_q ? "active" : ""; ?>"
         id="activities-q-<?php echo $q; ?>" style="display: none;">
