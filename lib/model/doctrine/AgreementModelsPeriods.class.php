...
class AgreementModelsPeriods extends BaseAgreementModelsPeriods
{
    ...
    {
        return $this->getModelsCountByStatus(self::STATUS_COMMENTED_BY_SPECIALIST);
    }
    ...
    private function getModelsCountByStatus($status)
    {
        return AgreementModelsPeriodsStatsTable::getInstance()
                ->createQuery()
